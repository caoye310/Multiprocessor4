 ...
 * JUnit based test
 *
 * Created on Oct 24, 2024, 8:27 PM
 */
 ...
 */
public class SpinSleepLockTest extends TestCase {
    ...
    SpinSleepLock instance = new SpinSleepLock(3);

    public SpinSleepLockTest(String testName) {
        super(testName);
    }
